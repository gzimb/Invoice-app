    ...
    <div class="header flex">
      <div class="left flex">
        ...
        <div class="status-button flex" :class="{
          ...
          <span style="background:transparent" v-if="currentInvoice.invoicePaid">Paid</span>
          <span style="background:transparent" v-if="currentInvoice.invoiceDraft">Draft</span>
          <span style="background:transparent" v-if="currentInvoice.invoicePending">Pending</span>
        </div>
      </div>
